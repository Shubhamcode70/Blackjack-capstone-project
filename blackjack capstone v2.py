...
if card1_user == 11:
    card1_user = int(input("Which value do you want to 1 or 11 :"))
elif card2_user == 11:
    card2_user = int(input("Which value do you want to 1 or 11 : "))
 
option = [1, 11]   
card3_computer = random.choice(cards_deck)
if card3_computer == 11:
    card3_computer = random.choice(option)
else:
    card3_computer = 11
